export enum SERVICE_TYPES {
  ...
  TOGGLE_HIDDEN_MODE = "TOGGLE_HIDDEN_MODE",
  LOAD_CACHED_ASSETS = "LOAD_CACHED_ASSETS",
  PROCESS_NEW_ASSETS = "PROCESS_NEW_ASSETS",
  GET_LUMEN_QUOTES = "GET_LUMEN_QUOTES",
  CANCEL_LOGIN_POLLING = "CANCEL_LOGIN_POLLING",
}

export enum EXTERNAL_SERVICE_TYPES {
  REQUEST_ACCESS = "REQUEST_ACCESS",
  SIGN_TRANSACTION = "SIGN_TRANSACTION",
  // for now added for compatibility. enams values must be exactly the same as keys
  // SIGN_TRANSACTION was as SUBMIT_TRANSACTION so to rename we need to add SUBMIT_TRANSACTION as well
